...
export const max_key_sz: number = max_sz(key_sz_sz);
export const max_value_sz: number = max_sz(value_sz_sz) - 1;
export const max_file_id: number = max_sz(file_id_sz);
export const max_record_sz: number = max_sz(record_sz_sz);
export const max_record_pos: number = max_sz(record_pos_sz);

export const max_manifest_id: number = max_sz(Type.UINT16);

export const TOMBSTONE: number = max_sz(value_sz_sz);
